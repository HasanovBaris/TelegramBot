...
//                    !update.getMessage().getText().equals("Mənim istədiyim yerə") && !update.getMessage().getText().equals("Yes I know the destination")
//                    && !update.getMessage().getText().equals("Где я хочу") && !update.getMessage().getText().equals("Travel Group təklif etsin") && !update.getMessage().getText().equals("İ am open to offers by the travel agency")
//                    && !update.getMessage().getText().equals("Пусть Travel Group подскажет")) {
...
//            if (update.getMessage().getText().equals("Mənim istədiyim yerə") || update.getMessage().getText().equals("Yes I know the destination") || update.getMessage().getText().equals("Где я хочу")) {
//                sendMessage.setReplyMarkup(new ReplyKeyboardRemove(true));
//            }
//        }
//    }
...
//
//
//                log.error("chat text {}", update.getMessage().getText());
//
...
//                redisHelperService.saveRedis(redisHelperService.getByChatId(Long.valueOf(sendMessage.getChatId())), update);
//                sendMessage.setText("Nomreniz ugurl qeyde alindi");
//            }
//        }
//    }
//
...
//
    ...
    public void start(Update update, SendMessage sendMessage) {
        ...
        if (userService.getUserByChatId(chatId) != null) {
            if (redisHelperService.getByChatId(chatId) != null && redisHelperService.getByChatId(chatId).getNextQuestion().equals("startingPoint") &&
                    !update.getMessage().getText().equals("Mənim istədiyim yerə") && !update.getMessage().getText().equals("Yes I know the destination")
                    && !update.getMessage().getText().equals("Где я хочу") && !update.getMessage().getText().equals("Travel Group təklif etsin") && !update.getMessage().getText().equals("Travel Time can offer")
...
//    }
    ...
    public void getUserDetail(Update update, SendMessage sendMessage) {
        ...
        if (update.getMessage().getText() != null && userService.getUserByChatId(update.getMessage().getChatId()) == null) {
            if (update.getMessage().getText().equals("/stop") || update.getMessage().getText().equals("/start")) {
                sendMessage.setText("Xahiş olunur,düzgün cavablar verin ki,sizə ən uyğun təklifi dəqiq şəkildə görə biləsiniz.Təkliflin sizə göndərilə bilməsi üçün nömrənizi paylaşınş");
                sendMessage.setReplyMarkup(setShareContact(update));
